...
- **TypeScript** — [`./references/typescript.md`]: Full utility types table, generic components, event
  typing
...
`ComponentPublicInstance`. Full utility types table in `./references/typescript.md`.
