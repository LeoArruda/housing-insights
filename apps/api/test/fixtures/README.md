...
| File | Used by | Notes |
|------|---------|--------|
| `wds-vector-data-response.json` | StatCan WDS data jobs / `statcan-wds-data-normalize` job | `getDataFromVectorsAndLatestNPeriods`-style array envelope; see [docs/specs/normalization-curated-layer/spec.md](../../../docs/specs/normalization-curated-layer/spec.md) |
