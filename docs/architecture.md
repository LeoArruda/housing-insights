...
- **Spec / tracking:** [docs/specs/web-ops-console/spec.md](specs/web-ops-console/spec.md); agent checklist [tasks.md](specs/web-ops-console/tasks.md); verification log [verification.md](specs/web-ops-console/verification.md). PRD: [docs/prds/prd-web-ops-console.md](prds/prd-web-ops-console.md).
